...
import { getAllGroups, getGroupById, createGroup, loginGroup, authGroup, updateGroup, deleteGroup, addPenalty, getGroupsPoints, getPoints, getAdminStatus } from '../controllers/GroupsController.js';
 ...
 *  get:
 *   tags: [Groups]
 *   summary: Indique si l'utilisateur est admin
 *   security:
 *    - clientAuth: []
 *    - userAuth: []
 *   responses:
 *    200:
 *     description: Retourne si il est admin
 *    401:
 *     description: Non autorisé
 *    404:
 *     description: Aucun groupe trouvé
 ...
 *     description: Erreur serveur
 */
groupRouter.get('/admin/', authClient, authUser, getAdminStatus);
